...
VALUES
    (1, 'Vanilla', 'Classic vanilla flavor', 'Milk, Vanilla extract, Sugar'),
    (2, 'Chocolate', 'Rich and creamy chocolate flavor', 'Milk, Chocolate syrup, Sugar'),
    (3, 'Strawberry', 'Sweet and fruity strawberry flavor', 'Milk, Strawberry syrup, Sugar'),
    (4, 'Mango', 'Tropical and refreshing mango flavor', 'Milk, Mango puree, Sugar'),
    (5, 'Banana', 'Creamy and ripe banana flavor', 'Milk, Banana, Sugar'),
    (6, 'Oreo', 'Cookies and cream flavor', 'Milk, Oreo cookies, Sugar'),
    (7, 'Caramel', 'Rich and smooth caramel flavor', 'Milk, Caramel syrup, Sugar'),
    (8, 'Coffee', 'Bold and aromatic coffee flavor', 'Milk, Coffee extract, Sugar'),
    (9, 'Pistachio', 'Creamy and nutty pistachio flavor', 'Milk, Pistachio paste, Sugar'),
    (10, 'Black Currant', 'Sweet and tangy black currant flavor', 'Milk, Black currant syrup, Sugar');
...
VALUES
    ...
    (106, 'Oreo Shake', 'Rich and cookies-n-cream flavored shake', 190, 6),
    (107, 'Caramel Shake', 'Smooth and caramel-flavored shake', 170, 7),
    (108, 'Coffee Shake', 'Bold and aromatic coffee-flavored shake', 180, 8),
    (109, 'Pistachio Shake', 'Creamy and nutty pistachio-flavored shake', 200, 9),
    (110, 'Mint Chocolate Chip Shake', 'Refreshing mint and chocolate chip flavored shake', 190, 2),
    (111, 'Cookies and Cream Shake', 'Classic cookies and cream flavored shake', 180, 6),
    (112, 'Salted Caramel Shake', 'Sweet and salty salted caramel flavored shake', 170, 7),
    (113, 'Hazelnut Shake', 'Rich and nutty hazelnut flavored shake', 200, 8),
    (114, 'Almond Shake', 'Creamy and almond-flavored shake', 190, 1),
    (115, 'Rocky Road Shake', 'Decadent chocolate, marshmallow, and nut flavored shake', 210, 2),
    (116, 'Raspberry Shake', 'Sweet and tangy raspberry-flavored shake', 170, 3),
    (117, 'Pineapple Shake', 'Refreshing and tropical pineapple-flavored shake', 160, 4),
    (118, 'Black Currant Shake', 'Sweet and tangy black currant-flavored shake', 180, 10),
    (119, 'Blueberry Shake', 'Delicious and fruity blueberry-flavored shake', 160, 3),
    (120, 'Peach Shake', 'Juicy and refreshing peach-flavored shake', 170, 4),
    (121, 'Mint Shake', 'Cool and refreshing mint-flavored shake', 180, 2),
    (122, 'Coconut Shake', 'Creamy and tropical coconut-flavored shake', 190, 5),
    (123, 'Butterscotch Shake', 'Rich and buttery butterscotch-flavored shake', 170, 7),
    (124, 'Peanut Butter Shake', 'Smooth and nutty peanut butter-flavored shake', 200, 6),
    (125, 'Red Velvet Shake', 'Indulgent and velvety red velvet cake-flavored shake', 210, 2),
    (126, 'Lemon Shake', 'Tangy and refreshing lemon-flavored shake', 160, 3),
    (127, 'Watermelon Shake', 'Juicy and summery watermelon-flavored shake', 170, 4),
    (128, 'Pistachio Almond Shake', 'Creamy and nutty blend of pistachio and almond flavors', 190, 9),
    (129, 'Mocha Shake', 'Rich and indulgent blend of coffee and chocolate flavors', 180, 8),
    (130, 'Coconut Mango Shake', 'Tropical blend of coconut and mango flavors', 190, 4),
    (131, 'Caramel Macchiato Shake', 'Smooth and caramel-flavored shake with a hint of coffee', 180, 7),
    (132, 'Black Forest Shake', 'Decadent and chocolatey shake with cherry flavor', 200, 2),
    (133, 'Peanut Butter Banana Shake', 'Creamy and nutty blend of peanut butter and banana flavors', 190, 5),
    (134, 'Strawberry Kiwi Shake', 'Refreshing combination of strawberry and kiwi flavors', 170, 3);   
...
VALUES
    ...
    (1002252, 'Anjali', 'Sharma', 'anjalis@yahoo.com',1),
    (1002253, 'Vikram', 'Singh', 'vikrams@gmail.com',1),
    ...
    INSERT INTO Orders (OrderID, CustomerID, OrderDate, MilkshakeID, StoreID, AmountSpent)
    VALUES
...
INSERT INTO Rewards (RewardID, RewardName, Description, StartDate, EndDate, CustomerID)
VALUES
    ...
    (4, 'Seasonal Promotion', 'Exclusive rewards during seasonal promotions', '2023-07-01', '2023-07-31', 1002234),
    (5, 'Anniversary Special', 'Celebrate your anniversary with a special reward', '2023-03-15', '2023-03-15', 1002235);
    
SELECT Customers.CustomerID, Customers.FirstName, Customers.LastName
FROM Customers
INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID
WHERE Orders.MilkshakeID = 101;
SELECT Customers.CustomerID, Customers.FirstName, Customers.LastName, SUM(Orders.AmountSpent) AS TotalAmountSpent
FROM Customers
INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID
...
LIMIT 5;
SELECT * FROM Rewards WHERE CustomerID = 1002233;
UPDATE Milkshakes
SET Price = 200.00
WHERE MilkshakeID = 101;
SELECT * FROM Milkshakes WHERE MilkshakeID = 101;
